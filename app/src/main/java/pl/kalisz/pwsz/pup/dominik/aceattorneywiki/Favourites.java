...
import static pl.kalisz.pwsz.pup.dominik.aceattorneywiki.MainActivity.PREFERENCES;
import static pl.kalisz.pwsz.pup.dominik.aceattorneywiki.MainActivity.WEB_LINKS;
import static pl.kalisz.pwsz.pup.dominik.aceattorneywiki.MainActivity.WEB_TITLE;
...
public class Favourites extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (o instanceof Map) {
                    Map map = (Map) o;
                    Intent in = new Intent(Favourites.this, MainActivity.class);
                    ...
                    if (jsonLink != null && jsonTitle != null) {
                        ...
                        for (int i = 0; i < linkArray.size(); i++) {
                            ...
                            if (titleArray.get(i).length() == 0)
                                map.put(TAG_TITLE, "Favourite " + (i + 1));
                            else
                        ...
                        adapter = new SimpleAdapter(Favourites.this,
                                listRowData, R.layout.favourites_list_row,
    ...
    private void deleteBookmark(final String title, final String link) {
        ...
        new AlertDialog.Builder(this)
                .setTitle("DELETE")
                .setMessage("Confirm that you want to delete this favourite?")
